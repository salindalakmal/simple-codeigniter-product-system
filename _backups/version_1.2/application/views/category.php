	...
	<div id="container">
		...
		<div id="main_content">
			<section id="section">
				<?php if($categories){ ?>
				<div id="products">
					<h1><a href="<?php echo base_url("products/category"); ?>">Category</a></h1>
					<?php foreach ($categories as $category) { ?>
					<div class="products"> 
						<h3><?php echo $category->name; ?></h3>
						<img src="<?php echo base_url("assests/categories/". $category->image); ?>" title="<?php echo $category->name; ?>">
						<!-- <p><?php //echo $product->description ?></p> -->
						<a href="<?php echo base_url("products/category/" . $category->name); ?>" title="<?php echo $category->name; ?>">View All</a>
					</div>  
					<?php }	?>
					<div class="clear"></div>
				</div>
